...
Select **Burn Bootloader** from the *Tools* menu. After this step, the external programmer is no longer needed.  
...
4. **If you want to flash directly via hardware programmer**: Hold the `SHIFT` key down while clicking the **Upload** icon.  
